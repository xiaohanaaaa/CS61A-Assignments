class Transaction:
    ...
    def changed(self):
        ...
        return not self.after==self.before
...
class BankAccount:
    ...
    def make_transactions(self,changed):
        self.transactions.append(Transaction(self.id, self.balance, self.balance+changed))
        self.id+=1
